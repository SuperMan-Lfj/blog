...
VERSION=$(ndk_getNDKVersion $S_NDK_PATH)
echo $VERSION

#  
# # choose api level
# S_NDK_API=($(file_listDirName "${S_NDK_PATH%*/}/platforms"))
# {
...
# 
# # choose arch 
# S_NDK_ARCH=($(file_listDirName "${S_NDK_PATH%*/}/platforms/$S_API"))
# {
